...
class _ProjectListPageState extends State<ProjectListPage> {
  List<Project> projects = [
    Project(
      ...
      duration2: '06 ก.พ. 2566 ถึง 06 มี.ค. 2566',
      area:
    ...
    Project(
      ...
      duration2: '01 ก.พ. 2566 ถึง 30 มิ.ย. 2566',
    ...
    Project(
      ...
      duration2: '01 ก.พ. 2566 ถึง 31 ม.ค. 2567',
      area:
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return Card(
            child: InkWell(
              onTap: () {
                _handleClickProjectItem(projects[index],index);
              },
              child: Padding(
  ...
  void _handleClickProjectItem(Project p,int index) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ProjectDetailsPage(project: p,showdetail: showdetail(index),)),
    );
  }
}
